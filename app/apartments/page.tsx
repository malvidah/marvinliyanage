...
const LISTINGS: Listing[] = [
  ...
  { id:'aoe', name:'Atomic Orchard Experiment', addr:'2510 NE Sandy Blvd · Kerns', price:'$1,805–$1,999', pn:'1BR · utilities separate', type:'apartment', beds:'1BR', score:82, status:'ok', isNew:false, lat:45.5317, lng:-122.6388,
    ...
    flags:[{t:'Confirmed split-level mezzanine layout',c:'fb'},{t:'Ask about concrete vs wood floors per unit',c:'fa'}],
    link:'https://www.apartments.com/atomic-orchard-experiment-portland-or/9bwstf4/', note:'Top loft-layout pick. Confirmed split-level with lofted bedroom and stairs — the Reddit OP literally toured this. Floor-to-ceiling windows, Kerns neighborhood. Main Q: verify if any units have wood floors throughout vs concrete.' },
